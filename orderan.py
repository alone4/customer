...
if modal.is_open():
    with modal.container():
            ...
            if check == "belum":
                ...
                harga_barang = st.number_input("harga barang awal", *args)
                diskon = st.number_input("jumlah diskon", *args)
                ongkir = st.number_input("biaya ongkir", *args)
                harga_akhir = st.number_input("harga akhir", values=harga_barang+ongkir-diskon)
